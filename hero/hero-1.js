...
function initHeroPhysics() {
  ...
  // Initialize shapes - matching original coordinates exactly
  window.heroPhysics.shapes = [
    bodyFromPath("shape1", 300, 200, "#094C45", "one", "#news"),
    bodyFromPath("shape2", 600, 250, "#F7A3BC", "two", "#founders"),
    bodyFromPath("shape3", 1000, 250, "#FFB533", "three", "#work"),
    bodyFromPath("shape4", 900, 500, "#88D3CD", "four", "#about"),
  ];
...
function addLogoSprite() {
  ...
  const logo = Matter.Bodies.fromVertices(
    220, // x position (center of canvas)
